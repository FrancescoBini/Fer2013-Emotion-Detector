...
class SimpleCNN2(nn.Module): ## usando nn.Conv2d per semplicità ed efficienza
    def __init__(self, num_classes=7):
...
class ResidualBlockResNet(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        super(ResidualBlockResNet, self).__init__()
...
class ResNet18(nn.Module):
    def __init__(self, num_classes=7):
        ...
        # Adjusted: grayscale input → 1 channel
    ...
    def _make_layer(self, out_channels, blocks, stride):
        ...
        layers = []
        layers.append(ResidualBlockResNet(self.in_channels, out_channels, stride, downsample=downsample))
        self.in_channels = out_channels
        for _ in range(1, blocks):
            layers.append(ResidualBlockResNet(out_channels, out_channels))
